...
function Digit({ place, value, height, digitStyle, isInView }: DigitProps) {
  ...
  let animatedValue = useSpring(0, { stiffness: 100, damping: 20 }) // Start from 0
...
export default function Counter({
  ...
  const isInView = useInView(ref, { once: true, margin: "0px 0px -50px 0px" }) // Trigger when component is 50px in view
  ...
  return (
    <div ref={ref} style={{ ...defaultContainerStyle, ...containerStyle }}>
